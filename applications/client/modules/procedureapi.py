...
class ProcedureApi(object):
    ...
    def write_value(self, dictionary):
        ...
        for key,val in dictionary.iteritems():
            ...
            db.module_values.update_or_insert((db.module_values.name == key) & (db.module_values.procedure_id == self.procedure_id),
    ...
    def read_value(self, key):
        ...
        db = current.db
        row = db((db.module_values.name == key) & (db.module_values.procedure_id == self.procedure_id)).select().first()
    ...
    def add_schedule(self,
        ...
        current.slugiot_scheduler.queue_task(
            ...
            pvars = {'procedure':self.procedure_id, 'function_args':function_args},
            repeats = repeats,
